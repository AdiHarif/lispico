...
mod tests {
    ...
    fn eval() {
        let programs = vec![
            ...
            ("(= 1 1)", Exp::Atom(Atom::Identifier("t".to_string()))),
            ("(= 1 2)", Exp::List(List::Nil)),
            ("(= 'a 'a)", Exp::Atom(Atom::Identifier("t".to_string()))),
            ("(= 'a 'b)", Exp::List(List::Nil)),
            (
                "(= '(1 2 3) '(1 2 3))",
                Exp::Atom(Atom::Identifier("t".to_string())),
            ),
            ("(= '(1 2 3) '(1 2))", Exp::List(List::Nil)),
